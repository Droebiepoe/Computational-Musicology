...
Here are 3 plots from the lab in week 10, a keygram and a Chordgram of the song *Numb* by *Linking Park*, using Temperley’s proposed improvements. The dominant chords seem to be F#:min, D:maj, Gb:maj and Gb:7, Where I expected F#min, D:maj, A:maj and E:maj.
...
LP_forest |> get_pr()
```
When using the whole repetoire, the model can predict the singer (Emily vs Chester) with 86% precision and 99% recall.
