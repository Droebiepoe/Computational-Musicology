...
Because Chester Bennington has a much bigger repetoire, I will primarily be comparing *Meteora* with *From Zero*.
...
Disclaimer: Be aware that these graphs are acquired using Spotify API, which is not a watertight indexing system. Results may vary.
:::
...
::: {.card heigth=5%}
Chester Bennington led the band through their iconic early era — raw, aggressive, emotionally intense. 
Since Emily Armstrong joined in 2024, the band has taken a new direction with *From Zero*. 
This portfolio analyses and compares the musical characteristics of both eras using computational musicology.
:::
...
Chester relaxes his voice far more.
:::
